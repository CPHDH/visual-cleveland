...
<section class="container min">	
	...
	<figure>
		...
		<figcaption>Fig1: Interactive map displaying historical city directory data for lower Euclid Avenue in Cleveland, Ohio (Public Square to East 9th Street). Source: Cleveland City Directories, select years from 1937 to 1997. <em><strong>NOTE:</strong> 2019 data was manually compiled by Mark Souther and is not part of any city directory.</em><br><a download class="data-download" href="euclid.csv">Download source data as .csv file</a>
		</figcaption>
	</figure>
